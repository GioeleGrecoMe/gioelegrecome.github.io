...
for tok in [
 ...
 'function modelByteSanity','function versionedLocalAsset',"searchParams.set('rsbuild',DEPLOY_REV)",
 'function mobileSamEncoderCandidates','function mobileSamDecoderCandidates','local-fp32','local-quant','browser-fp32','browser-quant','compat-fp32','compat-quant',
 'MOBILESAM_PAIR_REJECTED','MOBILESAM_PREFLIGHT_OK','function mobileSamEncoderPlan','function mobileSamEncoderProfile'
]: assert tok in s,tok
