...
/**
 * Creates a deterministic 3D numerical vector from text content.
 */
 ...
 */
const GraphViewer = ({ documents, proximityMatrix, onSelect, selectedElement, pathNodes, highlightedPath }) => {
    ...
    const getEdgeThickness = (similarity) => {
        ...
        const normalized = (similarity - 0.7) / (1.0 - 0.7);
        ...
        <div className="bg-gray-900 text-gray-100 font-sans w-full h-screen flex flex-col p-4 gap-4 relative">
            ...
            <main className="flex-grow grid grid-cols-5 gap-4 min-h-0">
                ...
                <section className="col-span-3 flex flex-col gap-2">
                    ...
                    <GraphViewer documents={documents} proximityMatrix={proximityMatrix} onSelect={setSelectedElement} selectedElement={selectedElement} pathNodes={pathNodes} highlightedPath={highlightedPath}/>
                </section>
                <aside className="col-span-1 min-h-0">
