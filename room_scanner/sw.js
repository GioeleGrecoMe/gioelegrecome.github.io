/* Room Scanner V12.2.1 service worker.
 *
 ...
 */
'use strict';
const BUILD_REV='1221-ortho-wall-guide-textures-20260817';
const CORE_CACHE='room-scanner-v1221-core';
const ASSET_CACHE='room-scanner-v1221-assets';
...
self.addEventListener('message',event=>{if(event.data?.type==='GET_BUILD')event.source?.postMessage?.({type:'ROOM_SCANNER_BUILD',version:'V12.2.1',revision:BUILD_REV,coreCache:CORE_CACHE,assetCache:ASSET_CACHE})});
