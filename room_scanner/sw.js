/* Room Scanner V12.2.4 service worker.
 *
 ...
 */
'use strict';
const BUILD_REV='1224-multiview-corner-anchors-closed-shell-20260817';
const CORE_CACHE='room-scanner-v1224-core';
const ASSET_CACHE='room-scanner-v1224-assets';
...
self.addEventListener('message',event=>{if(event.data?.type==='GET_BUILD')event.source?.postMessage?.({type:'ROOM_SCANNER_BUILD',version:'V12.2.4',revision:BUILD_REV,coreCache:CORE_CACHE,assetCache:ASSET_CACHE})});
