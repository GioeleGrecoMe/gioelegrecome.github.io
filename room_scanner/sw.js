/* Room Scanner V12.2.3 service worker.
 *
 ...
 */
'use strict';
const BUILD_REV='1223-xr-gaussian-wall-coverage-20260817';
const CORE_CACHE='room-scanner-v1223-core';
const ASSET_CACHE='room-scanner-v1223-assets';
...
self.addEventListener('message',event=>{if(event.data?.type==='GET_BUILD')event.source?.postMessage?.({type:'ROOM_SCANNER_BUILD',version:'V12.2.3',revision:BUILD_REV,coreCache:CORE_CACHE,assetCache:ASSET_CACHE})});
