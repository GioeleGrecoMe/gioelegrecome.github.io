/*
 * Room Scanner V20.0.0 - batch-only Depth Anything V2 worker
 * ------------------------------------------------------
 * The worker is intentionally created only after WebXR has ended and after
 * the V20 checkpoint/reload handoff. This prevents ARCore, Raw Camera buffers,
 * WebGL and ONNX Runtime from occupying the same mobile page instance.
 *
