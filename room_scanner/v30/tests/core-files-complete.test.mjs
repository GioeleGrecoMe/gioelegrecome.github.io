...
const required=['styles.css','manifest.webmanifest','icon.svg','js/app.js','js/logger.js','js/camera.js','js/formats.js','js/slam/math.js','js/slam/wasm_frontend.js','js/slam/slam_engine.js','js/xr/metric_bridge.js','js/gaussian/renderer.js','workers/gaussian_worker.js','workers/mvs_worker.js','wasm/slam_core.wasm'];
