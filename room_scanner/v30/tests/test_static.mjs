...
const html=fs.readFileSync(path.join(root,'room_scanner_v30.html'),'utf8');for(const id of ['cameraHeight','startBtn','loadPlyBtn','loadR30Btn','diagDownloadBtn','selfTestBtn','viewer'])if(!html.includes(`id="${id}"`))throw new Error(`HTML missing #${id}`);
