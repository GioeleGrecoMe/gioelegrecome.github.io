# Room Scanner V30.14.2 — AlvaAR autonomous world tracking

## Architectural correction

V30.14.2 restores a strict separation between **tracking** and **metric calibration**.
...
Reloading the page still creates a new Alva session; persistent serialization of the internal Alva world map is not implemented in V30.14.2.
...
V30.14.2 adds deterministic regression coverage for:
