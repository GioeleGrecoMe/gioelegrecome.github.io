/**
 * Room Scanner V30.43.0 final-pose dense consensus application.
 *
 * BOOT CONTRACT
 * -------------
 ...
 */
import {BUILD,CONFIG} from './config.js?v=30.43.0';
import {DiagnosticsLog} from './logger.js?v=30.43.0';
...
async function beginBridge(){
  // V30.43.0: only ProbabilisticJointOptimizer is operational; committed surface is rebuilt globally from confirmed dense evidence.
