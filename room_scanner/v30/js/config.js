/*
 * Room Scanner V30.11.2 runtime configuration.
 *
 * Debugging note:
...
export const BUILD={
  version:'30.11.2',
  id:'v30.11.2-20260819-nonblocking-metric-lock',
...
export const CONFIG={
  ...
  // No Depth Anything / DeepAI and no IMU are required by the V30.11.2 runtime.
  serviceWorker:'sw.js',
