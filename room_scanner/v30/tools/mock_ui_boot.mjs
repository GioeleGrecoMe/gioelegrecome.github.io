...
const ids=['home','calibration','bridge','scan','review','calibrateBtn','clearCalibrationBtn','calibSummary','startBtn','filePly','fileR30','homeStatus','savedSessions','buildBadge','buildFoot','calibOverlay','calibStatus','calibDepth','calibAddPinBtn','calibUndoPinBtn','calibFinishBtn','calibCancelBtn','bridgeCamera','bridgeCoach','bridgeFound','bridgeInliers','bridgeRmse','bridgeRetryBtn','bridgeCancelBtn','camera','miniMap','slamState','metricState','mvsState','statFeat','statMatch','statKf','statGs','statTri','coach','arModeBtn','pinBtn','finishBtn','viewer','backHomeBtn','fitBtn','viewTopBtn','viewFrontBtn','viewSideBtn','splatSize','reviewStats','exportPlyBtn','exportR30Btn','exportDiagBtn','resumeBtn','loadPlyBtn','loadR30Btn','diagPanel','diagLive','diagDownloadBtn','diagCopyBtn','selfTestBtn','forceUpdateBtn','diagForceUpdateBtn','selfTestSummary'];
...
if(els.get('buildBadge').textContent!=='V30.14.0')throw new Error('wrong badge');
