...
need('room_scanner_v20.html',['V20.2.2','grid-overlay','Salva ed esci da XR','markpoint-action','Pinna al reticolo']);
need('room_scanner_v12.html',['V20.2.2','grid-overlay','markpoint-action']);
...
need('processing.html',['V20.2.2','processing_ui_v20_2_0.js']);
need('sw_v20_2_0.js',['room-scanner-v20.2.2-shell-plane-marker-fix','room_scanner_v20.html','room_scanner_v12.html']);
need('build_info.json',['20.2.2','v20.2.2-20260818-shell-plane-marker-fix','room_scanner_v20.html']);
