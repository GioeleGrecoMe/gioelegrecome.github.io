...
need('room_scanner_v20.html',['V20.2.4','grid-overlay','Salva ed esci da XR','markpoint-action','Pinna al reticolo','telemetry-geometry']);
need('room_scanner_v12.html',['V20.2.4','grid-overlay','markpoint-action','telemetry-geometry']);
...
need('processing.html',['V20.2.4','processing_ui_v20_2_0.js','btn-preview-mesh','btn-preview-zoom-in']);
need('sw_v20_2_0.js',['room-scanner-v20.2.4-depth-guard-webxr-patch-mesh','model_preview_v20_2_4.js','preview_v20_2_4.css','room_scanner_v20.html','room_scanner_v12.html']);
need('build_info.json',['20.2.4','v20.2.4-20260818-depth-guard-webxr-patch-mesh','room_scanner_v20.html']);
...
need('js/model_preview_v20_2_4.js',['InteractiveModelPreview','structuralMesh','2 dita: sposta/zoom','zoomBy']);
