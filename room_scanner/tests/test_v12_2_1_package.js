...
ok(bi.appBuild==='V12.2.1'&&bi.deployRev==='1221-ortho-wall-guide-textures-20260817','build_info coerente V12.2.1');
ok(/room-scanner-v1221-core/.test(sw)&&/room-scanner-v1221-assets/.test(sw),'cache service worker dedicate V12.2.1');
ok(/version:'V12\.2\.1'/.test(sw)&&/1221-ortho-wall-guide-textures-20260817/.test(sw),'service worker espone build corretta');
...
if(fail)process.exit(1);console.log('\nTutti i test package V12.2.1 sono passati.');
