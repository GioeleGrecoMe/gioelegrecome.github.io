...
ok(bi.appBuild==='V12.2.0'&&bi.deployRev==='1220-guided-floor-shell-deep-20260817','build_info coerente V12.2.0');
ok(/room-scanner-v1220-core/.test(sw)&&/room-scanner-v1220-assets/.test(sw),'cache service worker dedicate V12.2.0');
ok(/version:'V12\.2\.0'/.test(sw)&&/1220-guided-floor-shell-deep-20260817/.test(sw),'service worker espone build corretta');
...
if(fail)process.exit(1);console.log('\nTutti i test package V12.2.0 sono passati.');
