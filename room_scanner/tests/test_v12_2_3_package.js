...
ok(bi.appBuild==='V12.2.3'&&bi.deployRev==='1223-xr-gaussian-wall-coverage-20260817','build_info coerente V12.2.3');
ok(/room-scanner-v1223-core/.test(sw)&&/room-scanner-v1223-assets/.test(sw),'cache service worker dedicate V12.2.3');
ok(/version:'V12\.2\.3'/.test(sw)&&/1223-xr-gaussian-wall-coverage-20260817/.test(sw),'service worker espone build corretta');
...
if(fail)process.exit(1);console.log('\nTutti i test package V12.2.3 sono passati.');
