# Phone Validation Protocol - V20.2.4
...
2. Open `room_scanner_v12.html` and verify the visible build is `V20.2.4`.
...
## V20.2.4 XR passthrough / depth and patch-mesh regression
