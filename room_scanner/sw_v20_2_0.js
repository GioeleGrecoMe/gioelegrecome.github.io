const CACHE='room-scanner-v20.2.0-shell';
const SHELL=[
  './','./index.html','./room_scanner_v12.html','./processing.html','./manifest.webmanifest','./build_info.json','./assets/icon.svg','./css/app_v20_2_0.css',
