...
export class MarkpointManager {
  ...
  async pin(pointId,candidate,{move=false}={}){
    ...
    if(move){point.position=observation.position;point.normal=observation.normal;point.descriptor=candidate.descriptor;point.referenceCameraPosition=camera;point.frameId=candidate.frameId||point.frameId;}
